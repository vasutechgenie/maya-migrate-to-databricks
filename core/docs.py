"""
docs.py -- Stage 6: generate comprehensive migration docs from the derived artifacts.
...
def run(cfg) -> dict:
    ...
    idx = [f"# {cfg.project_name} - Migration documentation", "",
           "Generated by MAYA Stage 6 from the derived migration artifacts.", "",
